      ...
      <div class="md:px-10 md:mt-32 md:mb-10">
        <div class="md:container md:mx-auto md:w-11/12 bg-center">
          <agile>
            ...
            <div class="slide">
              <img class="h-full w-full object-cover mx-auto md:rounded-lg"
                src="https://images.unsplash.com/photo-1532712938310-34cb3982ef74?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1500&q=80">
            </div>
          </agile>
        </div>
            ...
            <button class="focus:outline-none border px-3 h-24 w-24 bg-white shadow-lg rounded-full">
              ...
              style="enable-background:new 0 0 491.996 491.996;" xml:space="preserve">
                ...
                <path d="M124.672,120.253C106.389,102.93,33.28,97.319,11.307,96.018c-3.029-0.149-5.824,0.853-7.957,2.88
                  ...
                  c1.557-4.779,38.315-117.589,43.157-173.056C128.235,125.671,127.04,122.471,124.672,120.253z M66.88,287.997H21.333V118.098c34.283,2.709,71.275,8.597,84.715,15.125C100.395,179.943,74.816,262.951,66.88,287.997z"/>
                <path d="M501.333,117.33c-83.755,0-130.219,21.44-132.16,22.336c-2.773,1.301-4.843,3.712-5.696,6.635s-0.427,6.059,1.173,8.661c13.184,21.227,54.464,139.115,62.4,167.872c1.28,4.629,5.483,7.829,10.283,7.829h64c5.888,0,10.667-4.779,10.667-10.667v-192C512,122.087,507.221,117.33,501.333,117.33z M490.667,309.33h-45.355c-10.112-32.939-39.979-118.827-56.64-154.325c16.277-5.525,51.243-15.019,101.995-16.213V309.33z"/>
              </svg>
            </button>
          </div>
        ...
        <div class="hidden md:flex px-16">
          <div class="text-left md:w-2/3 md:text-2xl">
            <span class="">
              Mission
            </span>
          </div>
          <div class="text-center md:w-2/3 md:text-2xl">
            <span class="">
              Vision
            </span>
          </div>
          <div class="text-right md:w-2/3 md:text-2xl">
            <span class="">
              Values
            </span>
          </div>
...
<style lang="sass" src="./assets/css/vueagile.sass"></style>
